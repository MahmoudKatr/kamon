...
class _CancelledOrderState extends State<CancelledOrder> {
  ...
  Future<List<Order>> fetchOrders() async {
    ...
    final response = await http.get(Uri.parse('http://$baseUrl:4000/admin/customers/customerOrders/$customerId/10/cancelled'));
      ...
      body: FutureBuilder<List<Order>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No orders found cancelled'));
          } else {
